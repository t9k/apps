...
<!-- 你还可以使用 Enflame GCU、MetaX GPU 或 Hygon DCU 作为加速设备，需要将 `enflame.com/gcu` 分别替换为 `enflame.com/gcu`、`enflame.com/gcu` 和 `hygon.com/dcu`，并选用提供相应环境的镜像。 -->
...
server:
  image:
    registry: "registry.qingyang.t9kcloud.cn"
...
| 名称                                        | 描述                                           | 值                                   |
| ------------------------------------------- | ---------------------------------------------- | ------------------------------------ |
| `server.image.registry`                     | 服务器镜像的注册表                             | `registry.qingyang.t9kcloud.cn`      |
| `server.image.repository`                   | 服务器镜像的仓库                               | `topsrider/vllm-openai`                     |
| `server.image.tag`                          | 服务器镜像的标签                               | `20241223`                           |
