...
If you want to add pause functionality to your App, you need to add a `paused` field to the Helm Chart Values and handle the pause logic in the Helm Chart.
...
*   `template.versions[@].pausable` indicates whether the App can be paused.
